...
namespace Puelloc
{
    internal static class HttpResponseStatusCodes
    {
    ...
    public class HttpHeader : Dictionary<string, string>
    {
        ...
        /// <summary>
        /// Parse a line of string and add it into headers.
        /// It will replace the old value if the its value has already existed.
        /// </summary>
        ...
        /// <summary>
        /// Add a pair of header's name and value into headers.
        /// It will replace the old value if the its value has already existed.
        /// </summary>
